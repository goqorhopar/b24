...
class AutonomousServerBot:
    def __init__(self):
        ...
        logger.info(f"📱 Telegram Token: {'*' * 20}{self.telegram_token[-10:]}")
        logger.info(f"🧠 Gemini Key: {'*' * 20}{self.gemini_key[-10:]}")
        logger.info(f"📊 Bitrix Webhook: {self.bitrix_webhook[:50]}...")
